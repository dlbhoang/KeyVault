...
import { ShieldCheck, Zap, Calculator, HardHat } from 'lucide-react'
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--g-mesh)', display: 'flex', flexDirection: 'column' }}>
      ...
      <nav style={{
        ...
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}
          ...
          <div style={{
            ...
            background: 'var(--g-brand)', display: 'flex', alignItems: 'center',
            justifyContent: 'center', fontSize: 18, boxShadow: 'var(--s-indigo)'
          }}>
            🏗️
          </div>
        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}
          ...
          <motion.button
            ...
            style={{
              ...
              border: '1.5px solid var(--b2)', background: 'white',
              color: 'var(--t1)', fontWeight: 600, fontSize: 13, cursor: 'pointer'
            }}>
            Đăng nhập
          </motion.button>
        </motion.div>
      ...
      <div style={{
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: 'var(--s-indigo)', marginBottom: 28
          }}>
          🏗️
        </motion.div>
        ...
        <motion.h1
          ...
          style={{
            fontWeight: 800, fontSize: 'clamp(36px,6vw,60px)',
            lineHeight: 1.1, marginBottom: 18, maxWidth: 720, color: 'var(--t1)'
          }}>
          Phần mềm tính toán{' '}
          <span style={{ background: 'var(--g-brand)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            xây dựng chuyên nghiệp
          </span>
        </motion.h1>

        <motion.p
          initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .28 }}
          style={{ fontSize: 18, color: 'var(--t2)', maxWidth: 540, marginBottom: 40, lineHeight: 1.7 }}>
          Công cụ hỗ trợ kỹ sư xây dựng tính toán nhanh chóng các thông số kỹ thuật,
          quản lý dự án và tối ưu thiết kế công trình.
        </motion.p>

        <motion.div
          initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .36 }}
          ...
          <motion.button
            ...
            style={{
              ...
              fontWeight: 700, fontSize: 16, cursor: 'pointer', boxShadow: 'var(--s-indigo)'
            }}>
            🚀 Đăng ký nhận key
          </motion.button>
          ...
          <motion.button
            ...
            style={{
              ...
              border: '1.5px solid var(--b2)', background: 'white',
              color: 'var(--t1)', fontWeight: 700, fontSize: 16,
        ...
        <motion.div
          ...
          style={{
            ...
            gap: 16, maxWidth: 860, width: '100%', marginTop: 70
          }}>
          {features.map((f, i) => (
            <motion.div
              key={f.title}
              ...
              style={{
                background: 'white', border: '1.5px solid var(--b1)',
                borderRadius: 16, padding: '22px 20px',
                textAlign: 'left', boxShadow: 'var(--s2)'
              }}>
              <div style={{
              ...
              <div style={{ fontWeight: 700, fontSize: 15, marginBottom: 6, color: 'var(--t1)' }}>
                {f.title}
              </div>
      ...
      <footer style={{
        ...
        color: 'var(--t3)', borderTop: '1.5px solid var(--b1)',
