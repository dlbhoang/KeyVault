...
app.use(cors({
  origin: [
    ...
    'http://localhost:5174',
    'http://localhost:3000',
    'https://key-vault-gvry.vercel.app',
    'https://key-vault-nine.vercel.app'
  ],
  credentials: true,
...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', req.headers.origin || 'https://key-vault-gvry.vercel.app');
